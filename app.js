const PRODUCTS = [
    ...
    {category: "Décoration", price: "20 à 100 €", name: "Figurine d'un animé (one piece, naruto, demon slayer, hunter x hunter, tokyo revenger, fullmetal alchemist)", rate: "4.1", lien: "https://amazon.fr ou https://mangahako.com"},
    {category: "Décoration", price: "40 €", name: "cadre d'un animé (one piece, naruto, hunter x hunter, tokyo revenger, fullmetal alchemist)", rate: "4.6", lien: "https://displate.com"},
    ...
    {category: "Autres", price: "7 €", name: "Manga : https://www.listy.fr/l/73338/peinrr", rate: "4.6", lien: "https://www.fnac.be ; Club ; La traversée BD et manga (vervier)"},
